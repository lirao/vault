...
Configure the default lease time for generated SAS URI.
`

const pathConfigLeaseHelpDesc = `
This configures the default lease time used for SAS URIs
generated by this backend. The ttl specifies the duration that a
token will be valid for. SAS URI do not renew after lease expires.
